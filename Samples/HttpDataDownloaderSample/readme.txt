...
'CustomDataDownloader.dll' and the Class namespace as 'DataDownloader'. The package zipped and uploaded to storage account needs to be named 'DataDownloaderPackage.zip'. 
For more information, visit the Azure Data Factory Documentation Center and read 'Use Custom Activities in a Data Factory Pipeline'
