...
New-AzureDataFactoryLinkedService -DataFactoryName $df -File .\LinkedServices\AzureMachineLearningLinkedService.json -Name AzureMachineLearningLinkedService -ResourceGroupName ADF
